          ...
          <div className="neon-border-wrapper">
            <div className="relative glass-light dark:glass-dark rounded-3xl p-8 md:p-16 overflow-hidden">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-slate-800/80 border border-blue-200 dark:border-cyan-500/30 mb-6 animate-scale-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl mx-auto">
                <div className="relative group">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl opacity-0 group-hover:opacity-100 blur transition duration-300"></div>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <span>Example: https://www.youtube.com/playlist?list=PLxxxxxx</span>
                </div>
                ...
                <button
                  ...
                  className="group relative w-full py-6 px-8 rounded-2xl overflow-hidden transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 dark:bg-dark-800/50 border border-gray-100 dark:border-dark-700/50">
                  <div className="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/30">
                    <Clock className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Instant Results</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Get duration in seconds</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 dark:bg-dark-800/50 border border-gray-100 dark:border-dark-700/50">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Any Playlist</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Works with all public playlists</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 dark:bg-dark-800/50 border border-gray-100 dark:border-dark-700/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">No signup required</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative animate-fade-in-up">
          <div className="neon-border-wrapper">
            <div className="relative glass-light dark:glass-dark rounded-3xl p-8 md:p-12">
              ...
              <div className="flex items-start gap-6 mb-8 pb-8 border-b border-gray-200 dark:border-slate-700/50">
                <img
                  src={result.thumbnail}
                  alt={result.title}
                  className="w-32 h-20 md:w-48 md:h-28 object-cover rounded-xl shadow-lg flex-shrink-0"
                />
                <div className="flex-1 min-w-0">
                  <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mb-2 truncate">
                    {result.title}
                  </h2>
              ...
              <div className="text-center mb-8">
                <div className="text-sm uppercase tracking-wider text-gray-500 dark:text-slate-400 mb-3 font-medium">
                  Total Duration
                </div>
                ...
                <div className="text-lg text-gray-600 dark:text-slate-400 font-medium">
                  seconds
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-3 md:gap-4 mb-8">
                <div className="text-center p-4 rounded-xl bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/50">
              ...
              <button
                onClick={handleReset}
                className="w-full py-4 px-6 rounded-xl bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-semibold hover:bg-gray-800 dark:hover:bg-gray-100 transition-all duration-200 hover:scale-[1.01] active:scale-[0.99]"
              >
